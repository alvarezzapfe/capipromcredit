  ...
  return (
    <main style={{
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        {/* Logo */}
        <div className="login-fade-1" style={{ textAlign: "center", marginBottom: AVISO_PAGO ? 24 : 36 }}>
        ...
        {AVISO_PAGO && (
          <div className="login-fade-1" style={{
            ...
            <p style={{
              fontSize: 13, lineHeight: 1.55, color: "#b54848",
              fontFamily: "var(--font-body)", fontWeight: 500, margin: 0,
            }}>
              <strong style={{ fontWeight: 600 }}>Servicio con pago pendiente.</strong>{" "}
